...
4. Re-read the article file from disk. Then offer 2â€“3 candidate **next beats**: different directions the journey could pivot to from where the article now stands. Each must be reachable from the current grounded set; note what each one grounds.
5. Loop steps 3â€“5 until the article reaches a natural end.
