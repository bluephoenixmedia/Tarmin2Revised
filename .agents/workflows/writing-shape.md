...
3. **Draft 2â€“3 candidate openings.** Each opening should imply a different thesis or angle for the article. Show all of them. Force the user to pick or compose a hybrid. The chosen opening defines what the rest of the article must do.
...
- **Code block vs. inline code.** Multi-line, runnable, or illustrative â†’ block. Single token or identifier â†’ inline.
