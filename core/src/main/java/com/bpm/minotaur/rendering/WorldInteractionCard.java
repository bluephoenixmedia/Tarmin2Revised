...
public class WorldInteractionCard extends Table {
    ...
    public WorldInteractionCard(HudSkin skin) {
        ...
        Label.LabelStyle actionStyle = new Label.LabelStyle(skin.getFontMain(), HudSkin.COL_PARCHMENT_TEXT);
        Label.LabelStyle hintStyle = new Label.LabelStyle(skin.getFontSmall(), Color.valueOf("6B5636"));
        ...
        addListener(new ClickListener() {
            ...
            public void enter(InputEvent event, float x, float y, int pointer, Actor fromActor) {
                actionTextLabel.setColor(HudSkin.COL_PARCHMENT_HEADING);
            }

            @Override
            public void exit(InputEvent event, float x, float y, int pointer, Actor toActor) {
                actionTextLabel.setColor(HudSkin.COL_PARCHMENT_TEXT);
            }
        });
